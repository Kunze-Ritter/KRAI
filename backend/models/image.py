...
class ImageBase(BaseModel):
    ...
    document_id: str | None = Field(None, description="Associated document identifier.")
    chunk_id: str | None = Field(None, description="Associated chunk identifier.")
    filename: str | None = Field(None, description="Internal filename stored in R2.")
    original_filename: str | None = Field(None, description="Original uploaded filename.")
    storage_path: str | None = Field(None, description="Relative storage path inside the bucket.")
    storage_url: HttpUrl | None = Field(None, description="Public URL to access the image.")
    svg_storage_url: HttpUrl | None = Field(None, description="Public URL to the original SVG asset.")
    original_svg_content: str | None = Field(None, description="Inline SVG content for small vector graphics.")
    is_vector_graphic: bool | None = Field(False, description="Flag indicating if the asset is a vector graphic.")
    has_png_derivative: bool | None = Field(
        True,
    ...
    image_format: ImageFormat | None = Field(None, description="Image format/extension.")
    width_px: int | None = Field(None, ge=0, description="Image width in pixels.")
    height_px: int | None = Field(None, ge=0, description="Image height in pixels.")
    page_number: int | None = Field(None, ge=0)
    image_index: int | None = Field(None, ge=0, description="Index on the page if multiple images exist.")
    image_type: ImageType | None = Field(None, description="Categorisation of the image content.")
    ai_description: str | None = Field(None, description="Description generated by AI-based analysis.")
    ai_confidence: float | None = Field(
        None, ge=0.0, le=1.0, description="Confidence score for AI-generated description."
    )
    contains_text: bool | None = Field(None, description="Whether the image contains detected textual content.")
    ocr_text: str | None = Field(None, description="Text extracted by OCR processing, if available.")
    ocr_confidence: float | None = Field(None, ge=0.0, le=1.0, description="Confidence score for OCR extraction.")
    manual_description: str | None = Field(None, description="Manually curated description for the image.")
    tags: list[str] | None = Field(None, description="List of descriptive tags for categorisation.")
    file_hash: str | None = Field(None, description="SHA-256 hash used for deduplication." "")
    figure_number: str | None = Field(None, description="Figure reference number from the source document.")
    figure_context: str | None = Field(None, description="Additional context or captions related to the figure.")
...
class ImageUpdateRequest(ImageBase):
    ...
    storage_url: HttpUrl | None = Field(None)
...
class ImageFilterParams(BaseModel):
    ...
    date_from: str | None = Field(None, description="Filter by created_at >= date (YYYY-MM-DD).")
    date_to: str | None = Field(None, description="Filter by created_at <= date (YYYY-MM-DD).")
...
class ChunkSnippet(BaseModel):
    ...
    text_chunk: str | None = Field(None, description="Extracted textual content from chunk.")
...
class ImageWithRelationsResponse(ImageResponse):
    ...
    chunk: ChunkSnippet | None = Field(None)
